...
class HDFMapDigiSISCrate(HDFMapDigiTemplate):
    ...
    def _find_active_adcs(config_group: h5py.Group) -> Tuple[str, ...]:
        ...
        config_group :  `h5py.Group`
            HDF5 group object of the configuration group

        Returns
        -------
        Tuple[str, ...]
            tuple of active (used) analog-digital-converter names
        """
        active_adcs = []
    ...
    def _parse_config_name(self, name: str) -> Union[None, str]:
        ...
        ----------
        name : `str`
            name of potential configuration group
    ...
    def get_slot(self, brd: int, adc: str) -> Union[None, int]:
        ...
        brd : `int`
            board number
        adc : `str`
            digitizer analog-digital-converter name
