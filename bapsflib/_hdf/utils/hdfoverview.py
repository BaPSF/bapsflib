...
class HDFOverview(object):
    ...
    def __init__(self, hdf_obj: File):
        ...
        Parameters
        ----------
        hdf_obj : `~bapsflib._hdf.utils.file.File`
            HDF5 file object
        """
        super().__init__()
    ...
    def save(self, filename=""):
        ...
        filename : `str`, optional
            name of text file to save the overview report generated by
            :meth:`print`.  If no ``filename`` is given, then a text
            file ``.txt`` with the same name as the HDF5 file will be
            generated.
        """
        if filename == "":
    ...
    def report_digitizers(self, name=None):
        ...
        ----------
        name : `str`, optional
            name of digitizer. If `None` or ``name`` is not among
            digitizers, then all digitizers are printed.
        """
        # gather configs to print
    ...
    def report_controls(self, name=None):
        ...
        ----------
        name : `str`, optional
            name of control device. If `None` or ``name`` is not among
            controls, then all control devices are printed.
        """
        # gather configs to print
...
def status_print(
    ...
    ----------
    first : `str`
        string for 1st column

    second : `str`
        string for 2nd column
    third : `str`
    ...
    second_tab : `int`, optional
        number of characters between start of string and start of 2nd
        column (DEFAULT ``55``)
