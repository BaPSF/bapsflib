...
class HDFOverview(object):
    ...
    def print(self):
        ...
        print("Generated date: " + datetime.now().strftime(time_format))
        print("=" * 72 + "\n\n")
    ...
    def report_general(self):
        ...
        print("Abs. Path:    {}".format(self._file.info["absolute file path"]))
            ...
            for cname, config in digi.configs.items():
                ...
                for adc in config["adc"]:
                    ...
                    for iconn in range(nconns):
                        ...
                        line += "{}".format(adc_stats["clock rate"]).ljust(13)
