...
def build_shotnum_dset_relation(
    ...
    **dset**, to determine which indices contain the desired shot
    number(s)
    [for :class:`~bapsflib._hdf.utils.hdfreadcontrol.HDFReadControls`].
...
def condition_controls(hdf_file: File,
    ...
    :class:`~.hdfreadcontrol.HDFReadControls` and
...
def condition_shotnum(shotnum: Any,
    ...
    :class:`~bapsflib._hdf.utils.hdfreadcontrol.HDFReadControls` and
