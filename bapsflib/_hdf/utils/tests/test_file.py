...
class TestFile(TestBase):
    ...
    def test_file(self, _bf: File):
        ...
        self.assertEqual(_bf.info['file'],
                         os.path.basename(_bf.filename))
        self.assertEqual(_bf.info['absolute file path'],
        ...
        with mock.patch(File.__module__ + '.' + HDFMap.__qualname__,
        ...
        with mock.patch(
            ...
            cdata = _bf.read_controls(['control'], **extras,
                                      silent=False)
        ...
        # calling `read_msi`
        with mock.patch(
                HDFReadMSI.__module__ + '.' + HDFReadMSI.__qualname__,
                return_value='read msi') as mock_rm:
