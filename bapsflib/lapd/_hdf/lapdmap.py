...
class LaPDMap(HDFMap):
    """
    A specialized version of :class:`~bapsflib._hdf.maps.hdfmap.HDFMap`
    which adds attributes that are specific to mapping a HDF5 file
    generated by the LaPD.
    """
    def __init__(self, hdf_obj, control_path='Raw data + config',
    ...
    def exp_info(self):
        ...
        # assign values
        for key, val in \
                self._hdf_obj[self._DIGITIZER_PATH].attrs.items():
