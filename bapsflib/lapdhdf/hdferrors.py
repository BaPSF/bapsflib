...
class NotHDFFileError(Error):
    """
        Exception raised if passed object is not a h5py.File
        object.
    """
...
class NotLaPDHDFError(Error):
    """
        Exception raised if HDF5 file was not generated by the LaPD
        DAQ system.
    """
    def __init__(self):
        super().__init__('HDF5 File was not generated by LaPD Systems.')


class NotKnownLaPDHDFError(Error):
    """
        Exception raised if HDF5 file was generated by the DAQ system
