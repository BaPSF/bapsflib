...
HDF5 File Mapping (:class:`~bapsflib._hdf.maps.mapper.HDFMap`)
==============================================================
...
:class:`~bapsflib._hdf.map.mapper.HDFMap` constructs the mapping for
a given HDF5 file.  When a HDF5 file is opened with
:class:`~bapsflib.lapd.file.File`,
:class:`~bapsflib._hdf.maps.mapper.HDFMap` is automatically called to
